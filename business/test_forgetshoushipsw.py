...
i = 0
#业务流
class forgetshoushipsw(unittest.TestCase):
    def setUp(self):
    ...
    def test_forgetshoushipsw(self):
        try:
            ...
            publicmethods(self.driver).wait(page.ForgetShoushiPsw.忘记手势密码['type'],5,
                                            page.ForgetShoushiPsw.忘记手势密码['value'])
            publicmethods(self.driver).findelement(page.ForgetShoushiPsw.忘记手势密码['type'],
                                                   page.ForgetShoushiPsw.忘记手势密码['value']).click()
            publicmethods(self.driver).wait(page.ForgetShoushiPsw.输入交易密码['type'],5,
            ...
            publicmethods(self.driver).findelement(page.ForgetShoushiPsw.确定['type'],
                                                   page.ForgetShoushiPsw.确定['value']).click()
            publicmethods(self.driver).wait(page.ForgetShoushiPsw.请设置手势密码['type'],5,
            ...
            publicmethods(self.driver).wait(page.ForgetShoushiPsw.请再次绘制手势密码['type'],5,
